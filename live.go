...
func main() {
	...
	var live_sv = (live_server.LiveServer{Addr_connected_database: "localhost:8080", Addr_connected_node: "rpc.state-sync-02.theta-testnet.polypore.xyz", Data_channel: make(chan string)})
	// main net
